...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-brand-maroon text-white hover:bg-brand-maroon-dark disabled:bg-zinc-300 disabled:text-zinc-500 dark:disabled:bg-zinc-700 dark:disabled:text-zinc-400",
  secondary:
